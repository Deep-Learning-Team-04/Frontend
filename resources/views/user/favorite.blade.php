    ...
    <div class="w-full max-w-7xl px-6 mx-auto" x-data="{ result: null, liked: false }">
        ...
        <div class="flex gap-2">
            ...
            <div class="flex flex-col items-center w-1/3">
                <div class="w-60 h-60 bg-cover bg-center rounded flex items-center justify-center"
                    style="background-image: url('img/favorite.png');">
                </div>

                <h2 class="font-roboto text-[24px] font-semibold text-neu900 mb-8">Musik yang disukai</h2>
                <p class="font-inter text-[14px] font-medium text-primary mb-4">10 lagu | 35 Menit</p>
                <button id="playPause"
