        ...
        <div class="flex gap-2">
            ...
            <div class="flex flex-col items-center w-1/3">
                <div class="bg-[#D0E4F5] w-60 h-60 flex items-center justify-center rounded">
                    <img src="img/favorite.png" alt="favorite" class="w-full h-full" />
                </div>
                <h2 class="font-roboto text-[24px] font-semibold text-neu900">Nama favorite</h2>
                <p class="font-inter text-[16px] font-medium text-[#adb5af] mb-8">Deskripsi favorite</p>
